...
const MenuItem = (props: Props) => {
    ...
    const clickHandler = () => {
        ...
        dispatch(navActions.activate(title));
    ...
    return (
        <motion.li
            ...
            className={`${isActive ? 'text-white' : 'text-slate-400'} text-4xl sm:text-xl md:text-lg lg:text-3xl cursor-pointer hover:text-white`}
