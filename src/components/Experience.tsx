...
const Experience = () => {
    ...
    return (
        <div id='experience' ref={ref} className='flex flex-col justify-center items-center gap-12 bg-charcoal-light sm:gap-24 w-full min-h-screen py-12 overflow-x-hidden overflow-y-hidden'>
