...
const MenuButton = () => {
    ...
    return (
        <button onClick={clickHandler} className='flex flex-col justify-center items-center self-end gap-1 rounded-full h-12 w-12 bg-indigo-300 visible sm:hidden border-none fixed top-0 right-0 mt-4 mr-4 focus:outline-none z-20'>
