...
const Projects = () => {
    ...
    return (
        <div ref={ref} id='projects' className='flex flex-col justify-center items-center gap-12 bg-charcoal sm:gap-24 w-full h-[1400px] sm:min-h-screen py-12 overflow-x-hidden overflow-y-hidden'>
